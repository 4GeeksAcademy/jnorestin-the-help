  ...
  return (
    <div className="help-slider-container">
      {datadummy.map((item, index) => {
        return (
          <div className="help-slider-card" key={index}>
            <div className="help-slider-picture">
              <img src={item.img} alt="User Profile" className="custom-profile-image" />
            </div>
            <p className="custom-card-text">{item.description}</p>
